========================================================================
		ActiveX Control DLL : PLOT
========================================================================

ControlWizard has created this project for your PLOT ActiveX Control
...
that make up your PLOT ActiveX Control DLL.
...
PlotCtl.h
	This file contains the declaration of the CPlotCtrl C++ class.

PlotCtl.cpp
	This file contains the implementation of the CPlotCtrl C++ class.

PlotPpg.h
	This file contains the declaration of the CPlotPropPage C++ class.

PlotPpg.cpp
	This file contains the implementation of the CPlotPropPage C++ class.

PlotCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CPlotCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Plot.rc.
