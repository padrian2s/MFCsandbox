================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : PDFCreator Project Overview
===============================================================================

The application wizard has created this PDFCreator application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your PDFCreator application.
...
PDFCreator.h
    ...
    CPDFCreatorApp application class.

PDFCreator.cpp
    This is the main application source file that contains the application
    class CPDFCreatorApp.
...
res\PDFCreator.ico
    ...
    icon is included by the main resource file PDFCreator.rc.
...
PDFCreatorDlg.h, PDFCreatorDlg.cpp - the dialog
    These files contain your CPDFCreatorDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in PDFCreator.rc, which can be edited in Microsoft Visual C++.
DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CPDFCreatorDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named PDFCreator.pch and a precompiled types file named StdAfx.obj.
