...
// CclsPDFCreator0 wrapper class

class CclsPDFCreator0 : public COleDispatchDriver
{
public:
	CclsPDFCreator0(){} // Calls COleDispatchDriver default constructor
	CclsPDFCreator0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CclsPDFCreator0(const CclsPDFCreator0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
