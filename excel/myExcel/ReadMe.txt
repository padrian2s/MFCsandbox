================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : myExcel Project Overview
===============================================================================

The application wizard has created this myExcel application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your myExcel application.
...
res\myExcel.ico
    ...
    icon is included by the main resource file myExcel.rc.
...
myExcelDlg.h, myExcelDlg.cpp - the dialog
    These files contain your CmyExcelDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in myExcel.rc, which can be edited in Microsoft Visual C++.
DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CmyExcelDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named myExcel.pch and a precompiled types file named StdAfx.obj.
