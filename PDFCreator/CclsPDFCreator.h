...
// CclsPDFCreator wrapper class

class CclsPDFCreator : public COleDispatchDriver
{
public:
	CclsPDFCreator(){} // Calls COleDispatchDriver default constructor
	CclsPDFCreator(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CclsPDFCreator(const CclsPDFCreator& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
