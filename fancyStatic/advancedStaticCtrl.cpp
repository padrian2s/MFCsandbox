...
CStaticCtrlStyled::CStaticCtrlStyled(HDC hSourceDC, LPCTSTR lpszText, UINT uiHorzAlignment, UINT uiVertAlignment)
 {
...
CStaticCtrlStyled::~CStaticCtrlStyled()
 {
  Clear();
 }
...
void CStaticCtrlStyled::AngleBlt(HDC hSourceDC, HDC hDestDC, RECT rectSource, UINT uiAngle)
 {
  ...
  if ( CStaticStyledCtrl::IsWindowsNT2000() ) // Windows NT/2000
   {
    POINT stPoints[3];
...
CSize CStaticCtrlStyled::GetLengthlyTextSize(HDC hDC, CStringArray *parrayText)
 {
  CSize cMaxSize(0,0);
...
BOOL CStaticCtrlStyled::BitBltText(int X, int Y)
 {
...
BOOL CStaticCtrlStyled::BitBltText(CRect rectSource)
 {
  if (!m_hRotatedMemDC) return FALSE;
...
void CStaticCtrlStyled::GetRotatedDC(CDC *pDC)
 {
...
void CStaticCtrlStyled::GetRotatedRect(RECT *pstRect)
 {
...
BOOL CStaticCtrlStyled::RotateText(UINT uiAngle)
 {
  ...
  for (int I=0; I<arrayText.GetSize(); I++)
   {
    ...
    stRect.left   = 0; //tm.tmAveCharWidth-tm.tmExternalLeading+1;
    stRect.top    = 1; //I * sizeText.cy;
...
void CStaticStyledCtrl::DrawAlignedText(CDC *pDC, LPCSTR lpszText, RECT stRect, UINT uiAlignment)
 {
  UINT uiFormat = 0;
...
int CStaticStyledCtrl::GetWindowText(LPTSTR lpszStringBuf, int nMaxCount)
 {
...
void CStaticStyledCtrl::GetWindowText(CString &rString)
 {
  m_bBlockMessage = TRUE;
...
BOOL CStaticStyledCtrl::IsMultiLineString(LPCSTR lpszText)
 {
...
CString CStaticStyledCtrl::MakeVerticalText(LPCSTR lpszText)
 {
...
void CStaticStyledCtrl::SetWindowText(LPCTSTR lpszString)
 {
  m_bBlockMessage = TRUE;
...
void CStaticStyledCtrl::TrackMouse(BOOL bHover, BOOL bLeave)
 {
...
BOOL CStaticStyledCtrl::IsWindowsNT2000()
 {
...
CStaticStyledCtrl &CStaticStyledCtrl::FlashBackground(BOOL bActivate, UINT uiTime)
 {
...
CStaticStyledCtrl &CStaticStyledCtrl::FlashText(BOOL bActivate, UINT uiTime)
 {
  if (m_bTextFlash)
   {
...
void CStaticStyledCtrl::ForceNoOwnerDraw(BOOL bForce)
 {
...
BOOL CStaticStyledCtrl::GetBorder()
 {
...
UINT CStaticStyledCtrl::GetHorzAlignment()
 {
...
UINT CStaticStyledCtrl::GetHorzAlignmentIndex()
 {
...
BOOL CStaticStyledCtrl::GetSunken()
 {
...
UINT CStaticStyledCtrl::GetVertAlignment()
 {
...
UINT CStaticStyledCtrl::GetVertAlignmentIndex()
 {
...
CStaticStyledCtrl &CStaticStyledCtrl::SetAlignment(UINT uiAlign)
 {
  DWORD dwRemove = 0;
  DWORD dwHorz = 0;
  DWORD dwVert = 0;
...
CStaticStyledCtrl &CStaticStyledCtrl::SetAngle(UINT uiAngle)
 {
  m_uiAngle = uiAngle;
  RedrawWindow();
  return *this;
...
CStaticStyledCtrl &CStaticStyledCtrl::SetBackImage(UINT nID)
 {
  if (m_hBackImage) DeleteObject(m_hBackImage);
...
CStaticStyledCtrl &CStaticStyledCtrl::SetBorder(BOOL bSet)
 {
...
CStaticStyledCtrl &CStaticStyledCtrl::SetCursor(HCURSOR hCursor)
 {
  m_hCursor = hCursor;
  return *this;
 }
...
CStaticStyledCtrl &CStaticStyledCtrl::SetCursor(UINT uiCursorID)
 {
...
CStaticStyledCtrl &CStaticStyledCtrl::SetDisabled(BOOL bSet)
 {
...
CStaticStyledCtrl &CStaticStyledCtrl::SetLink(BOOL bSet)
 {
  m_bLink = bSet;
  return *this;
 }
...
CStaticStyledCtrl &CStaticStyledCtrl::SetLinkCursor(HCURSOR hCursor)
 {
  m_hCursor = hCursor;
  return *this;
 }
...
CStaticStyledCtrl &CStaticStyledCtrl::SetLinkCursor(UINT uiCursorID)
 {
  m_hCursor = LoadCursor(AfxGetInstanceHandle(), MAKEINTRESOURCE(uiCursorID));
  return *this;
 }
...
CStaticStyledCtrl &CStaticStyledCtrl::SetLowerCase(BOOL bSet)
 {
  m_bLowerCase = bSet;
  m_bUpperCase = FALSE;
  RedrawWindow();
...
CStaticStyledCtrl &CStaticStyledCtrl::SetSunken(BOOL bSet)
 {
...
CStaticStyledCtrl &CStaticStyledCtrl::SetUpperCase(BOOL bSet)
 {
  m_bLowerCase = FALSE;
  m_bUpperCase = bSet;
  RedrawWindow();
...
CStaticStyledCtrl &CStaticStyledCtrl::SetVerticalText(BOOL bSet)
 {
...
CStaticStyledCtrl &CStaticStyledCtrl::StretchBitmap(BOOL bStretch)
 {
...
CStaticStyledCtrl &CStaticStyledCtrl::UseBevelLine(BOOL bUse)
 {
...
CStaticStyledCtrl &CStaticStyledCtrl::UseHighLighting(BOOL bUse)
 {
...
CStaticStyledCtrl &CStaticStyledCtrl::UseHighLightingOnlyWithToolTip(BOOL bUse)
 {
...
CStaticStyledCtrl &CStaticStyledCtrl::UseLeftMouseButtonForToolTip(BOOL bUse)
 {
...
HBRUSH CStaticStyledCtrl::CtlColor(CDC *pDC, UINT nCtlColor)
 {
  ...
  if (CTLCOLOR_STATIC == nCtlColor)
   {
    CFont *oldFont=pDC->SelectObject(&m_cFont);
...
void CStaticStyledCtrl::OnEnable(BOOL bEnable) 
 {
  SetRedraw(FALSE);
...
BOOL CStaticStyledCtrl::OnEraseBkgnd(CDC* pDC) 
 {
...
void CStaticStyledCtrl::OnLButtonDown(UINT nFlags, CPoint point) 
 {
  if (m_bLink)
   {
...
void CStaticStyledCtrl::OnMouseMove(UINT nFlags, CPoint point) 
 {
  if (!m_bInside)
   {
    m_bInside = TRUE;
...
BOOL CStaticStyledCtrl::OnSetCursor(CWnd* pWnd, UINT nHitTest, UINT message) 
 {
  if (m_hCursor)
   {
    ::SetCursor(m_hCursor);
...
void CStaticStyledCtrl::OnTimer(UINT nIDEvent) 
 {
  switch(nIDEvent)
   {
    case 1 : // TEXT FLASH
...
void CStaticStyledCtrl::OnPaint() 
 {
  ...
  CStaticCtrlStyled CStaticCtrlStyled(dc.GetSafeHdc(), strText, uiHorzAlignment, uiVertAlignment);

  CStaticCtrlStyled.SetTextColor(m_clrTextColor);

  CStaticCtrlStyled.SetDisabledText((GetStyle() & WS_DISABLED) == WS_DISABLED);

  CStaticCtrlStyled.DrawBevelLine(m_bUseBevelLine);

  CStaticCtrlStyled.SetBackgroundColor(!m_bUseDefaultTextBackColor ? m_clrTextBackColor : m_bUseDefaultBackColor ? ::GetSysColor(COLOR_3DFACE) : m_clrBackColor);
  ...
  if (m_bBackFlash && m_bFlashBackState)
   {
    ...
    CStaticCtrlStyled.SetBackgroundColor(clr);
   }
  ...
  if (m_hBackImage &&
      ...
      (!IsMultiLineString(strText) || (IsMultiLineString(strText) && GetVertAlignment() == VERT_TOP)))
   {
    ...
    DrawAlignedText(&dc, strText, rectClient, m_uiAlignment);
        ...
        BOOL bRet = CStaticCtrlStyled.RotateText(m_uiAngle);

        if (bRet)
         {
          CRect rectRotated = CStaticCtrlStyled.GetRotatedRect();

          // Draw Text
          CStaticCtrlStyled.BitBltText(rectClient);
         }
       }
