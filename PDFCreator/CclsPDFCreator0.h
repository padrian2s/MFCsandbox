// CclsPDFCreator0.h  : Declaration of ActiveX Control wrapper class(es) created by Microsoft Visual C++
...
class CclsPDFCreator0 : public CWnd
{
protected:
	DECLARE_DYNCREATE(CclsPDFCreator0)
public:
